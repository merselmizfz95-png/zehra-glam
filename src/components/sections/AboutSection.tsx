        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <ScrollReveal variant="slide-left">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-48 h-64 rounded-2xl overflow-hidden border-4 border-background shadow-2xl hidden sm:block">
                <Image
              ...
              <div className="absolute -top-4 -left-4 px-6 py-4 bg-primary text-primary-foreground rounded-2xl shadow-xl">
            ...
            <div>
              ...
              <div className="mt-10 grid grid-cols-3 gap-6">
                {stats.map((stat) => (
                  <div
                    key={stat.label}
                    className="relative p-5 rounded-2xl bg-muted/50 border border-border/50 text-center"
                  >
